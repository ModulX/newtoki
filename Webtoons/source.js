...
class Webtoons extends paperback_extensions_common_1.Source {
    ...
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            langString = (_a = lang[0]) !== null && _a !== void 0 ? _a : 'en'; // This variable is only to be used in the "getMangaShareUrl" function.
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tagSearch;
            if (query.title) {
                const searchType = (_c = (_b = query === null || query === void 0 ? void 0 : query.includedTags) === null || _b === void 0 ? void 0 : _b.map((x) => x.id)[0]) !== null && _c !== void 0 ? _c : 'WEBTOON'; // Search will return "Canvas" titles or "Original" titles. Original is default. Cannot return both.
                tagSearch = searchType;
                request = createRequestObject({
                    url: `${WEBTOONS_DOMAIN}/${lang[0]}/search?keyword=${((_d = query.title) !== null && _d !== void 0 ? _d : '').replace(/ /g, '+')}&searchType=${searchType}&page=${page}`,
                    method: 'GET'
                });
            }
            else {
                const hasTag = (_e = query === null || query === void 0 ? void 0 : query.includedTags) === null || _e === void 0 ? void 0 : _e.map((x) => x.id)[0];
                if (hasTag) {
                    type = 'tag';
                    tagSearch = hasTag;
                }
...
class Parser {
    parseMangaDetails($, mangaId) {
        ...
        const title = (_b = (_a = $('.subj').text().split('\n')[0]) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : '';
        const desc = (_c = $('p.summary').text().trim()) !== null && _c !== void 0 ? _c : '';
        const image = (_d = $('.background_pic').find('img').attr('src')) !== null && _d !== void 0 ? _d : $('.detail_chal_pic').find('img').attr('src');
    ...
    parseSearchResults($, langString, type, tagSearch) {
        ...
        if (type == 'title') {
            ...
            for (const result of $(resultUl).find('li').toArray()) {
                ...
                const subtitle = (_b = $(result).find('.author').text().trim()) !== null && _b !== void 0 ? _b : '';
                if (!id || !title)
                    continue;
                const image = (_c = $(result).find('img').attr('src')) !== null && _c !== void 0 ? _c : '';
        ...
        if (type == 'tag') {
            ...
            */
            ...
            for (const title of $('.card_wrap.genre').find('h2').toArray()) {
                const tagTitle = (_d = $(title).attr('data-genre-seo')) === null || _d === void 0 ? void 0 : _d.trim();
                if (!tagTitle)
                    continue;
            ...
            */
            ...
            for (const comicTile of (_e = tagComicsArray[index]) !== null && _e !== void 0 ? _e : []) {
                ...
                const image = (_h = $(comicTile).find('img').attr('src')) !== null && _h !== void 0 ? _h : '';
                const subtitle = (_j = $(comicTile).find('.author').text().trim()) !== null && _j !== void 0 ? _j : '';
                if (!id || !title)
                    continue;
                results.push(createMangaTile({
                    id: id,
    ...
    parseHomeSections($, sectionCallback, langString) {
        ...
        for (const popularComic of $('.ranking_lst.popular').next().find('ul > li').toArray()) {
            if (popularArray.length >= 10)
                break;
            const id = (_b = (_a = $('a', popularComic).attr('href')) === null || _a === void 0 ? void 0 : _a.split(`${langString}/`)[1]) !== null && _b !== void 0 ? _b : '';
            ...
            const subtitle = (_e = $(popularComic).find('.author').text().trim()) !== null && _e !== void 0 ? _e : '';
        ...
        for (const newTrendComic of $('ul.lst_type1').find('li').toArray()) {
            if (newTrendArray.length >= 10)
                break;
            const id = (_g = (_f = $('a', newTrendComic).attr('href')) === null || _f === void 0 ? void 0 : _f.split(`${langString}/`)[1]) !== null && _g !== void 0 ? _g : '';
            const image = (_h = $(newTrendComic).find('img').attr('src')) !== null && _h !== void 0 ? _h : '';
            const title = (_j = $(newTrendComic).find('.subj').text().trim()) !== null && _j !== void 0 ? _j : '';
            const subtitle = (_k = $(newTrendComic).find('.author').text().trim()) !== null && _k !== void 0 ? _k : '';
        ...
        for (const canvasComic of $('.ranking_lst.popular').next().next().find('ul > li').toArray()) {
            if (canvasArray.length >= 10)
                break;
            const id = (_m = (_l = $('a', canvasComic).attr('href')) === null || _l === void 0 ? void 0 : _l.split(`${langString}/`)[1]) !== null && _m !== void 0 ? _m : '';
            const image = (_o = $(canvasComic).find('img').attr('src')) !== null && _o !== void 0 ? _o : '';
            const title = (_p = $(canvasComic).find('.subj').text().trim()) !== null && _p !== void 0 ? _p : '';
            const subtitle = (_q = $(canvasComic).find('.author').text().trim()) !== null && _q !== void 0 ? _q : '';
