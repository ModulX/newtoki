...
class NewToki2 extends paperback_extensions_common_1.Source {
    ...
    async getSourceMenu() {
        return Promise.resolve(createSection({
            ...
            rows: async () => [
                await (0, NewToki2Settings_1.contentSettings)(this.stateManager),
            ]
        }));
    }
...
},{"./NewToki2Settings":49,"paperback-extensions-common":4}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const getLanguages = async (stateManager) => {
    return await stateManager.retrieve('language') ?? exports.WTLanguages.getDefault();
};
