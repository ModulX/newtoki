...
class Webtoons extends paperback_extensions_common_1.Source {
    ...
    async getSourceMenu() {
        return Promise.resolve(createSection({
            ...
            rows: async () => [
                await (0, WebtoonsSettings_1.contentSettings)(this.stateManager),
            ]
        }));
    }
    ...
    async getMangaDetails(mangaId) {
        const lang = await (0, WebtoonsSettings_1.getLanguages)(this.stateManager);
    ...
    async getSearchResults(query, metadata) {
        ...
        if (query.title) {
            ...
            const hasTag = query?.includedTags?.map((x) => x.id)[0];
            if (hasTag) {
                type = 'tag';
                tagSearch = hasTag;
            }
